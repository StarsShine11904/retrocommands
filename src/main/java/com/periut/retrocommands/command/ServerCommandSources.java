 ...
 * clients running the mod (see {@code com.periut.retrocommands.network}).
 */
public final class ServerCommandSources {
    ...
    static final class ServerFeedback {
        ...
        static void send(final ServerPlayerEntity player, final com.periut.retrocommands.text.Text message) {
            com.periut.retrocommands.network.RichMessages.send(player, message);
        }
    }
}
