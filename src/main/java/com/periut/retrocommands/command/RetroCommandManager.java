...
import com.periut.retrocommands.command.builtin.AdminCommands;
import com.periut.retrocommands.command.builtin.ClearChatCommand;
import com.periut.retrocommands.command.builtin.ClearCommand;
import com.periut.retrocommands.command.builtin.GameModeCommand;
import com.periut.retrocommands.command.builtin.GiveCommand;
import com.periut.retrocommands.command.builtin.GodCommand;
import com.periut.retrocommands.command.builtin.HatCommand;
import com.periut.retrocommands.command.builtin.HealCommand;
import com.periut.retrocommands.command.builtin.HelpCommand;
import com.periut.retrocommands.command.builtin.KillCommand;
import com.periut.retrocommands.command.builtin.ListCommand;
import com.periut.retrocommands.command.builtin.MeCommand;
import com.periut.retrocommands.command.builtin.MessageCommand;
import com.periut.retrocommands.command.builtin.MiscCommands;
import com.periut.retrocommands.command.builtin.NoclipCommand;
import com.periut.retrocommands.command.builtin.RideCommand;
import com.periut.retrocommands.command.builtin.SayCommand;
import com.periut.retrocommands.command.builtin.SeedCommand;
import com.periut.retrocommands.command.builtin.SummonCommand;
import com.periut.retrocommands.command.builtin.TeleportCommand;
import com.periut.retrocommands.command.builtin.TimeCommand;
import com.periut.retrocommands.command.builtin.TpaCommand;
import com.periut.retrocommands.command.builtin.WarpCommand;
import com.periut.retrocommands.command.builtin.WeatherCommand;
import com.periut.retrocommands.text.Formatting;
import com.periut.retrocommands.text.MutableText;
...
public class RetroCommandManager {
    ...
    public int execute(final RetroCommandSource source, final String command) {
        try {
            ...
            RetroCommands.LOGGER.warning("Command '" + command + "' threw " + ex);
            return 0;
        }
    }
