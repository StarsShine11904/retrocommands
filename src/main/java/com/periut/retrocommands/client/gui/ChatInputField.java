...
public class ChatInputField extends DrawContext {
    ...
    public void render(final int x, final int y) {
        ...
        TextDrawer.INSTANCE.draw(textRenderer, renderTextProvider.apply(visible, firstCharacterIndex), x, y, TEXT_COLOR, 255);
        ...
        if (focusedTicks / CURSOR_BLINK_TICKS % 2 == 0) {
            ...
            if (cursor < text.length()) {
                ...
                drawTextWithShadow(textRenderer, "_", cursorX, y, TEXT_COLOR);
            }
        }
    }
